...
function rt_qr_shortcode( $atts ) {
	...
	<div class="rt-qr-wrapper"
		...
		<div class="rt-qr-card">
			<div class="rt-qr-grid">
				<div class="rt-qr-col rt-qr-col-left">
				...
				<div class="rt-qr-col rt-qr-col-right">
					<div class="rt-qr-colors">
						...
						<div class="rt-qr-presets" aria-label="Preset colors">
							...
							<?php endforeach; ?>
							<span class="rt-qr-presets-hint">click a preset to apply to the focused chip</span>
						</div>
					</div>
